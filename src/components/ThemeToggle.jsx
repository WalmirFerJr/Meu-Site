...
export default function ThemeToggle({ onMount }) {
  ...
  return (
    <button
      ...
      style={{
        backgroundColor: isDark ? '#3C3233' : '#E5DBCF',
      }}
    ...
    >
      <motion.div
        ...
        style={{
          backgroundColor: isDark ? '#DFD1C4' : '#3C3233',
        }}
        initial={false}
        animate={{
          x: isDark ? 24 : 0,
      ...
      >
        {isDark ? (
          ...
          <svg className="w-4 h-4 text-[#F9FBF8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
