...
const companies = ['Itaú Unibanco', 'BTG Pactual', 'USP']

export default function Hero() {
  return (
    <section
      className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20 pb-16 bg-[#FDFBF7] dark:bg-dark-canvas overflow-hidden"
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(60% 45% at 50% 30%, rgba(139, 87, 42, 0.10) 0%, rgba(139, 87, 42, 0) 70%)',
        }}
        aria-hidden
      />
      ...
      <div className="relative max-w-4xl mx-auto text-center flex-1 flex flex-col justify-center">
        ...
        >
          ...
          <strong className="text-[#262322] dark:text-dark-text-primary">USP</strong>.
          <br />
          Construo pipelines de grande volumetria e sistemas backend escaláveis na{' '}
          <strong className="text-[#262322] dark:text-dark-text-primary">AWS</strong>.
        </motion.p>
        ...
        >
          <p className="text-[10px] uppercase tracking-[0.2em] text-[#262322]/45 dark:text-dark-text-secondary/70 mb-3">
            Experiência em
          </p>
          <ul className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2" role="list">
            {companies.map((company) => (
              <li
                key={company}
                className="font-medium text-sm md:text-base text-[#262322]/55 dark:text-dark-text-secondary/80"
              >
                {company}
              </li>
            ))}
