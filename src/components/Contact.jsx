...
export default function Contact() {
  const contactLinks = [
    {
      href: 'mailto:walmir.jr.2004@usp.br',
      label: 'walmir.jr.2004@usp.br',
      icon: (
    ...
    {
      href: 'https://wa.me/5511911145999',
      label: '(11) 91114-5999',
      icon: (
    ...
    {
      href: 'https://github.com/WalmirFerJr',
      label: 'GitHub',
      icon: (
        <svg className="w-5 h-5 shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto text-center">
        <motion.h2
          id="contact-heading"
          className="section-title after:mx-auto"
        ...
        >
          Oportunidade de estágio ou projeto? Adoraria conversar.
        </motion.p>
